...
public interface FeedbackRepository extends JpaRepository<Feedback, Integer> {
    ...
    void sendFeedback(@Param("type") int type, @Param("senderId") int senderId, @Param("message") String message, @Param("modifyDate") Timestamp modifyDate, @Param("isCompleted") int isCompleted);
